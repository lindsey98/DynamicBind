...
parser.add_argument('prediction_result_path', type=str, default='results/test/index0_idx_0',
...
parser.add_argument('rank', type=str, default="1", help='specify the sample to generate movie.\
             (the samples are sorted by their confidence, '
            'with rank 1 being considered the best prediction by the model, rank 40 the worst), \
...
parser.add_argument('--python', type=str,
                    default='/home/ruofan/anaconda3/envs/dynamicbind/bin/python', help='point to the python in dynamicbind env.')
parser.add_argument('--relax_python', type=str,
                    default='/home/ruofan/anaconda3/envs/relax/bin/python', help='point to the python in relax env.')
